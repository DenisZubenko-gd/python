...
#Формируем строку, вставляемые знаки должны быть двухназные, недостающее заполняем нулями
# со слишком большыми числами не пробовал, скорее всего обрежет часы
